...
_NEWS_ASK = (
    "You are researching this week's NFL games for a betting desk. "
    "For EACH matchup below, report ONLY factual, current items with sources, "
    "anchored on the official injury report designations and inactives news: "
    "THE STARTING QUARTERBACK STATUS FIRST for both teams (starter confirmed / "
    "backup starting / QB questionable — name the QBs explicitly), then other key "
    "players listed OUT / DOUBTFUL / QUESTIONABLE, and expected inactives. "
    "Weather for outdoor stadiums if meaningful (wind 15+ mph, heavy rain/snow, extreme cold). "
        ...
        r = requests.post(
            ...
            json={
                ...
                "messages": [
                    {
                        "role": "system",
                        "content": "Return tight factual NFL team news. Cite when possible. No fabrications.",
                    },
