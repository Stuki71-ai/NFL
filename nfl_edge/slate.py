...
from nfl_edge.config import MARKETS, ODDS_FORMAT, REGIONS, SPORT_KEY, env
...
def fetch_odds(date_et: str | None = None) -> tuple[list[dict[str, Any]], str | None]:
    ...
    historical snapshot (~11:00 ET that day — before the 13:00 ET Sunday window,
    the main replay case; Thu/Mon replays see the same-day late snapshot too).
    ...
    if date_et:
        ...
        snap_et = datetime(y, m, d, 11, 0, 0, tzinfo=ET)
