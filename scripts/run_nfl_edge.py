...
"""CLI for NFL EDGE.
  ...
  python scripts/run_nfl_edge.py --date 2026-07-26 --dry-run   # historical test
"""
...
from nfl_edge.pipeline import run  # noqa: E402
from nfl_edge.utils import safe_print  # noqa: E402
...
def main() -> int:
    ap = argparse.ArgumentParser(description="NFL EDGE runner")
